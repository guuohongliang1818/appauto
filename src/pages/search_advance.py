...
class SearchAdvance:
    ...
    def category_search(self, select_type, category_type):
        ...
        if select_type == 1:
            # 获取话题帖子选项
            return self.goto_topic_posts_search()
        elif select_type == 2:
            return self.goto_category_tag_search()
        elif select_type == 3:
            return self.goto_username_search()
